...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'ai', label: 'ArtFlow AI', path: '/ai', icon: Sparkles },
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center py-1 px-1.5 min-w-[52px] rounded-xl transition-all duration-200 ${
                isActive
                  ? 'text-[#F1E2CB]'
                  : isAI
                  ? 'text-[#D9B98D] hover:text-[#F1E2CB]'
            ...
            >
              ...
              <span
                className={`text-[10px] font-sans mt-1 tracking-tight truncate max-w-[56px] ${
