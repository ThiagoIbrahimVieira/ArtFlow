...
export type DeviantArtQuery = z.infer<typeof DeviantArtQuerySchema>;
export type ColorMuseRequest = z.infer<typeof ColorMuseRequestSchema>;
export type GeminiPalette = z.infer<typeof GeminiPaletteSchema>;
